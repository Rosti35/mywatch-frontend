...
export const Switch = ({id, children, className, ...props}: SwitchProps) => (
  ...
  >
    ...
    <SwitchPrimitive.Root
      className="min-w-[52px] max-w-[52px] min-h-[28px] max-h-[28px] bg-blackA6 rounded-full relative focus:shadow-black data-[state=checked]:bg-black outline-none cursor-default data-[state=unchecked]:bg-themed-grey-400"
      id={id}
    >
