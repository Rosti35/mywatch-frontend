...
export const TabTriggerWithBadge = ({
  ...
  return (
    <TabTrigger
      {...props}
      disableTransition
      className="sm:px-6 px-4 md:py-3 min-h-[50px] h-full leading-5 text-nowrap [&>div]:bg-themed-black-primary [&>div]:text-white w-full flex transition-all gap-[10px] justify-center rounded-full bg-white sm:text-sm text-[14px]"
