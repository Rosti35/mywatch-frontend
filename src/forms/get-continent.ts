// Source: https://github.com/BRIXTOL/country-continent/

import {AnyCase, LiteralUnion} from '@/types/util';
 ...
 */
export type GetContinentCodes<ISO> = ISO extends keyof IContinents ? IContinents[ISO] : never;
 ...
 */
export type ContinentName<Code> = Code extends keyof IContinentNames
  ? IContinentNames[Code]
  : never;
...
export function getContinentCode<ISO extends AnyCase<keyof IContinents>>(
  ...
  const continentCode = ContinentCodes[code.toUpperCase() as keyof IContinents];

  if (!continentCode) throw new Error(`"${code}" is an invalid ISO country code`);

  return continentCode as GetContinentCodes<Uppercase<ISO>>;
}
...
export function getContinentName<ISO extends AnyCase<keyof IContinents>>(
  ...
  return ContinentNames[continentCode as keyof IContinentNames] as ContinentName<
    GetContinentCodes<Uppercase<ISO>>
  >;
}
