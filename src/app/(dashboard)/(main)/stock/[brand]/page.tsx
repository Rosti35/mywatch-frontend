...
export default function Page() {
  return (
    <div className="sm:pt-[39px] sm:pr-[40px] sm:pl-[22px] p-4">
      <DashboardPageLayout title={<Title />}>
        <div className="flex flex-col gap-[30px]">
          <div className="flex flex-col gap-[30px]">
            <CardRoot className="p-[30px] bg-themed-grey-100">
              <p className="text-md font-bold tracking-tight leading-8 mb-1">Rolex Daytona</p>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-[3px] justify-center">
                        <p className="font-semibold text-sm leading-[30px]">Rolex</p>
                        <p className="sm:leading-5 tracking-wide">
